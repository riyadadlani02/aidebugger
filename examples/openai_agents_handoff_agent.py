"""An openai-agents support agent that hands off without the constraint the customer gave.
    ...
    aidebugger run -- python examples/openai_agents_handoff_agent.py
    aidebugger trap --trapset openai_agents --hook on-handoff
    aidebugger trap examples.openai_agents_handoff_agent.decide_replacement
    aidebugger poll 0
