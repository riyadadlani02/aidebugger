"""A pydantic-ai billing agent that credits an account a hundred times over.
    ...
    aidebugger run -- python examples/pydantic_ai_billing_agent.py
    aidebugger trap --trapset pydantic_ai --hook on-tool-call
    aidebugger trap examples.pydantic_ai_billing_agent.credit_for
    aidebugger poll 0
