"""Runnable with `pytest tests/` or plain `python tests/test_aidebugger.py`."""
import json
import sys
import time
...
from aidebugger import engine as engine_module
...
def test_http_control_plane_end_to_end():
    from aidebugger.server import serve
...
def test_symbol_in_the_running_script_resolves_to_the_live_module():
    ...
    try:
        from aidebugger.engine import resolve
...
def test_installed_trapsets_fully_resolve():
    ...
    from aidebugger import trapsets
