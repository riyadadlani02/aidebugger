...
The console (aidebugger/ui.html) stays the single source of truth; this only injects a
...
def main():
    ...
    html = html.replace("<title>aidebugger console</title>",
                        "<title>aidebugger console — live demo</title>")
